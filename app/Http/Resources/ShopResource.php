...
class ShopResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'background_img'    => $this->background_img ? (str_starts_with((string)$this->background_img, 'http') ? $this->background_img : config('app.img_host') . $this->background_img) : null,
            'logo_img'          => $this->logo_img ? (str_starts_with((string)$this->logo_img, 'http') ? $this->logo_img : config('app.img_host') . $this->logo_img) : null,
