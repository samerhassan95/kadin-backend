...
//    Route::get('/login/{provider}',                 [LoginController::class,'redirectToProvider']);
    ...
    Route::group(['prefix' => 'dashboard', 'middleware' => ['sanctum.check', 'check.ip']], function () {
        ...
        Route::group(['prefix' => 'user', 'middleware' => ['sanctum.check'], 'as' => 'user.'], function () {
            ...
            Route::post('pay-stack-process',     [Payment\PayStackController::class,     'processTransaction']);
            Route::post('pay-tabs-process',      [Payment\PayTabsController::class,      'processTransaction']);
        ...
        Route::group(['prefix' => 'seller', 'middleware' => ['sanctum.check', 'role:seller|moderator|admin'], 'as' => 'seller.'], function () {
            ...
            Route::apiResource('extra/groups', Seller\ExtraGroupController::class)->names('seller_extra_groups');
            Route::delete('extra/groups/delete',    [Seller\ExtraGroupController::class, 'destroy']);

            Route::apiResource('extra/values', Seller\ExtraValueController::class)->names('seller_extra_values');
            ...
            Route::apiResource('property/groups', Seller\PropertyGroupController::class)->names('seller_property_groups');
            Route::delete('property/groups/delete', [Seller\PropertyGroupController::class, 'destroy']);

            Route::apiResource('property/values', Seller\PropertyValueController::class)->names('seller_property_values');
        ...
        Route::group(['prefix' => 'admin', 'middleware' => ['sanctum.check', 'role:admin|seller|manager'], 'as' => 'admin.'], function () {
            ...
            Route::apiResource('extra/groups', Admin\ExtraGroupController::class)->names('admin_extra_groups');
            ...
            Route::apiResource('extra/values', Admin\ExtraValueController::class)->names('admin_extra_values');
            ...
            Route::apiResource('property/groups', Admin\PropertyGroupController::class)->names('admin_property_groups');
            ...
            Route::apiResource('property/values', Admin\PropertyValueController::class)->names('admin_property_values');
    ...
    Route::group(['prefix' => 'webhook'], function () {
        ...
        Route::any('pay-stack/payment',    [Payment\PayStackController::class,    'paymentWebHook']);
        Route::any('pay-tabs/payment',     [Payment\PayTabsController::class,     'paymentWebHook']);
